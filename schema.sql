...
-- Web Push subscriptions & notification dedup log (Issue #48).
-- See migrations/005_push_subscriptions.sql for context — this section
-- mirrors that migration so a fresh setup running just schema.sql picks
-- up the same tables/indexes.
