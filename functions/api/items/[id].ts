...
export const onRequestPatch: PagesFunction<Env> = async ({ request, env, params }) => {
  ...
  await notifyHouseholdSync(env, existing.household_id as string, { type: 'item.updated', householdId: existing.household_id as string, payload: { id } });
...
export const onRequestDelete: PagesFunction<Env> = async ({ request, env, params }) => {
  ...
  await notifyHouseholdSync(env, existing.household_id as string, { type: 'item.deleted', householdId: existing.household_id as string, payload: { id } });
